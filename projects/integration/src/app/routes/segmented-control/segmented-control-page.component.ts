...
@Component({
  selector: 'int-segmented-control-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [RouterOutlet, RouterLink, RouterLinkActive, TabNavBarComponent, TabLinkDirective],
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <h1 class="mb-4 text-4xl font-bold text-surface-900">Segmented Control</h1>
      <p class="mb-8 text-lg text-surface-600">
        A horizontal group of mutually exclusive options where one is always selected.
        Ideal for toggling between views or filtering content.
      </p>

      <nav com-tab-nav-bar class="mb-8" aria-label="Segmented Control documentation tabs">
