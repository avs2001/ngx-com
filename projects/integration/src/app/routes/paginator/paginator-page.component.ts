...
@Component({
  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <com-item
        title="Paginator"
        description="Navigation controls for paginated content with page size selection and range display."
        icon="chevrons-left-right-ellipsis"
        size="lg"
        class="mb-8"
      />

      <nav com-tab-nav-bar class="mb-8" aria-label="Paginator documentation tabs">
