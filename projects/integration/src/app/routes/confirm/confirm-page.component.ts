...
@Component({
  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <com-item
        title="Confirm"
        description="A directive that intercepts clicks and displays a confirmation panel before allowing actions to proceed."
        icon="alert-triangle"
        size="lg"
        class="mb-8"
      />

      <nav com-tab-nav-bar class="mb-8" aria-label="Confirm documentation tabs">
