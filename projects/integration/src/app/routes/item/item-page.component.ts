...
@Component({
  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <com-item
        title="Item"
        description="A universal compound display element that shows a leading visual alongside a title, description, and trailing content."
        icon="layers"
        size="lg"
        class="mb-8"
      />

      <nav com-tab-nav-bar class="mb-8" aria-label="Item documentation tabs">
