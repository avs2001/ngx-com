...
@Component({
  ...
  imports: [ComDropdown, ComDropdownOptionTpl, CodeBlock, RouterLink],
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      ...
      <h1 class="mb-4 text-4xl font-bold text-surface-900">Dropdown Examples</h1>
      <p class="mb-8 text-lg text-surface-600">
        Interactive examples demonstrating different dropdown configurations.
      </p>
